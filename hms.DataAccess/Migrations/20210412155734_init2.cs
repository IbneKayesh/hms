        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DEPARTMENT_NAME_BANGLA = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    IS_ACTIVE = table.Column<bool>(type: "bit", nullable: false),
                    CREATE_DATE = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CREATE_BY = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    CREATE_DEVICE = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<int>(type: "int", nullable: false),
                    EMPLOYEE_TYPE_NAME = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IS_ACTIVE = table.Column<bool>(type: "bit", nullable: false),
                    CREATE_DATE = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CREATE_BY = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    CREATE_DEVICE = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMPLOYEE_NAME_BANGLA = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    PRESENT_ADDRESS = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PERMANENT_ADDRESS = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    EMPLOYEE_DEGREE = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    EMPLOYEE_DEGREE_BANGLA = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    EMPLOYEE_SPECIALITY = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    EMPLOYEE_SPECIALITY_BANGLA = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    EMPLOYEE_OTHERS = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    EMPLOYEE_OTHERS_BANGLA = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    EMPLOYEE_REG_NO = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    EMPLOYEE_REG_NO_BANGLA = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    ...
                    EMPLOYEE_NATIONAL_ID = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IS_ACTIVE = table.Column<bool>(type: "bit", nullable: false),
                    CREATE_DATE = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CREATE_BY = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    CREATE_DEVICE = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HP_TOKEN_HS_EMPLOYEE_EMPLOYEE_ID",
                        column: x => x.EMPLOYEE_ID,
                        principalTable: "HS_EMPLOYEE",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HP_SHOW_TYPE_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HP_PRESCRIPTION_EMPLOYEE_ID",
