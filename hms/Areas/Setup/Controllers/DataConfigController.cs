    ...
    public class DataConfigController : Controller
    {
        ...
        private void US_CHILD_MENU_Ins()
        {
            List<US_CHILD_MENU> _d = new List<US_CHILD_MENU>
            {
                ...
                new US_CHILD_MENU{ ID=10, CHILD_NAME="User Role", CHILD_BN_NAME="User Role", CHILD_ICON="fa fa-users", AREA_NAME="Setup", CONTROLLER_NAME="UserRole", ACTION_NAME="ManageUserRole", US_MODULE_ID=1, US_PARENT_MENU_ID=1 },
