...
namespace hms.Areas.Setup.Controllers
{
    ...
    public class DataConfigController : Controller
    {
        ...
        private void US_USER_Ins()
        {
            ...
            {
                new US_USER{ LOGIN_ID ="admin",PASSWORD="abc@123",USER_NAME="Administrator",MOBILE_NO="01000000000",EMAIL_ID="admin@hms.com",DATE_OF_BIRTH=DateTime.Now.Date,PROFILE_IMAGE="-",US_GENDER_ID=1,US_RELIGION_ID=1,US_BLOOD_GROUP_ID=1,US_MARITAIL_STATUS_ID=1,US_TYPE_ID=1}
            };
